...
//------------------------------------------------------
//this is 1 based algorithm that  is the nodes starts from 1
...
//        u--,v--;
    ...
    for(set<int>::iterator it=result_of_articaultion_points.begin(); it!=result_of_articaultion_points.end(); it++)
    {
        cout<<*it<<endl;
    }
    return 0;
