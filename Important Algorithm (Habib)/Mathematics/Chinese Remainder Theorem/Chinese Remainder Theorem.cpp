...
//------------------------------------------------------
//Theorem statement
//Suppose n1, ..., nk are positive integers that are pairwise
//coprime. Then, for any given sequence of integers a1, ...,
//ak, there exists an integer x solving the following system
...
ll chinese_remainder_theorem(vector<ll> ns, vector<ll> as) //ns = array of n's and as is the array of a's
{
    int k  = ns.size();
    ll N = 1, x = 0, r, s, g;
    for (int i = 0; i < k; ++i)
