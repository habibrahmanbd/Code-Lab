...
//*************************************************My Code Starts Here*********************************************************************************
int prec[300];//precidence (it should be filled by user)

//make postfix notation with variables and numbers with proper bracketing
void postfix(string &a,string &b)
{
    ...
    for(i=0;i<SZ(a);i++)
    {
        ...
        else if(a[i]=='(') {b.pb(' '); s.push(a[i]);} //opening bracket
